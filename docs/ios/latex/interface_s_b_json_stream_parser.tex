\hypertarget{interface_s_b_json_stream_parser}{}\section{S\+B\+Json\+Stream\+Parser クラス}
...
Using this class is also useful to parse huge documents on disk bit by bit so you don\textquotesingle{}t have to keep them all in memory.
...
\index{parse\+:@{parse\+:}!S\+B\+Json\+Stream\+Parser@{S\+B\+Json\+Stream\+Parser}}
...
\index{delegate@{delegate}!S\+B\+Json\+Stream\+Parser@{S\+B\+Json\+Stream\+Parser}}
\subsubsection[{delegate}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (id$<${\bf S\+B\+Json\+Stream\+Parser\+Delegate}$>$) delegate\hspace{0.3cm}{\ttfamily [read]}, {\ttfamily [write]}, {\ttfamily [atomic]}, {\ttfamily [unsafe_unretained]}}\label{interface_s_b_json_stream_parser_a1a4e90ce1ca9b55e7696db77ef6bf20c}
...
\index{max\+Depth@{max\+Depth}!S\+B\+Json\+Stream\+Parser@{S\+B\+Json\+Stream\+Parser}}
...
\index{support\+Multiple\+Documents@{support\+Multiple\+Documents}!S\+B\+Json\+Stream\+Parser@{S\+B\+Json\+Stream\+Parser}}
