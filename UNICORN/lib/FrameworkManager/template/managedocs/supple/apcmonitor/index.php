...
if (file_exists(dirname(__FILE__)."/apc.conf.php")) include(dirname(__FILE__)."/apc.conf.php");
////////////////////////////////////////////////////////
...
defaults('USE_AUTHENTICATION',1);			// Use (internal) authentication - best choice if 
											...
											//  this work!
defaults('ADMIN_USERNAME','test'); 			// Admin Username
defaults('ADMIN_PASSWORD','testtest');  	// Admin Password - CHANGE THIS TO ENABLE!!!
